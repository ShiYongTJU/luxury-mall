...
async function createAuthTables() {
  try {
    ...
    const defaultButtonPermissions = [
      ...
      // 数据源管理按钮权限
      { id: 'perm_btn_carousel_add', code: 'button:carousel:add', name: '新增轮播图', parentId: 'perm_menu_operation_carousel', path: 'carousel:add', sortOrder: 21 },
      { id: 'perm_btn_carousel_edit', code: 'button:carousel:edit', name: '编辑轮播图', parentId: 'perm_menu_operation_carousel', path: 'carousel:edit', sortOrder: 22 },
      { id: 'perm_btn_carousel_delete', code: 'button:carousel:delete', name: '删除轮播图', parentId: 'perm_menu_operation_carousel', path: 'carousel:delete', sortOrder: 23 },
      { id: 'perm_btn_seckill_add', code: 'button:seckill:add', name: '新增秒杀', parentId: 'perm_menu_operation_seckill', path: 'seckill:add', sortOrder: 31 },
      { id: 'perm_btn_seckill_edit', code: 'button:seckill:edit', name: '编辑秒杀', parentId: 'perm_menu_operation_seckill', path: 'seckill:edit', sortOrder: 32 },
      { id: 'perm_btn_seckill_delete', code: 'button:seckill:delete', name: '删除秒杀', parentId: 'perm_menu_operation_seckill', path: 'seckill:delete', sortOrder: 33 },
      { id: 'perm_btn_groupbuy_add', code: 'button:groupbuy:add', name: '新增团购', parentId: 'perm_menu_operation_groupbuy', path: 'groupbuy:add', sortOrder: 41 },
      { id: 'perm_btn_groupbuy_edit', code: 'button:groupbuy:edit', name: '编辑团购', parentId: 'perm_menu_operation_groupbuy', path: 'groupbuy:edit', sortOrder: 42 },
      { id: 'perm_btn_groupbuy_delete', code: 'button:groupbuy:delete', name: '删除团购', parentId: 'perm_menu_operation_groupbuy', path: 'groupbuy:delete', sortOrder: 43 },
      { id: 'perm_btn_productList_add', code: 'button:productList:add', name: '新增商品列表', parentId: 'perm_menu_operation_productList', path: 'productList:add', sortOrder: 51 },
      { id: 'perm_btn_productList_edit', code: 'button:productList:edit', name: '编辑商品列表', parentId: 'perm_menu_operation_productList', path: 'productList:edit', sortOrder: 52 },
      { id: 'perm_btn_productList_delete', code: 'button:productList:delete', name: '删除商品列表', parentId: 'perm_menu_operation_productList', path: 'productList:delete', sortOrder: 53 },
      { id: 'perm_btn_guessYouLike_add', code: 'button:guessYouLike:add', name: '新增猜你喜欢', parentId: 'perm_menu_operation_guessYouLike', path: 'guessYouLike:add', sortOrder: 61 },
      { id: 'perm_btn_guessYouLike_edit', code: 'button:guessYouLike:edit', name: '编辑猜你喜欢', parentId: 'perm_menu_operation_guessYouLike', path: 'guessYouLike:edit', sortOrder: 62 },
      { id: 'perm_btn_guessYouLike_delete', code: 'button:guessYouLike:delete', name: '删除猜你喜欢', parentId: 'perm_menu_operation_guessYouLike', path: 'guessYouLike:delete', sortOrder: 63 },
      // 图片管理按钮权限
      { id: 'perm_btn_image_add', code: 'button:image:add', name: '新增图片', parentId: 'perm_menu_product_image_list', path: 'image:add', sortOrder: 71 },
      { id: 'perm_btn_image_edit', code: 'button:image:edit', name: '编辑图片', parentId: 'perm_menu_product_image_list', path: 'image:edit', sortOrder: 72 },
      { id: 'perm_btn_image_delete', code: 'button:image:delete', name: '删除图片', parentId: 'perm_menu_product_image_list', path: 'image:delete', sortOrder: 73 },
      // 权限管理按钮权限
