...
function GuessYouLikeManagement() {
    ...
    try {
      ...
      if (isEditMode && editingItem) {
        ...
        await datasourceApi.createItem('guessYouLike', {
          name: values.name,
          dataSourceType: 'guessYouLike',
          abbreviation: getDataSourceAbbreviation('guessYouLike'),
          data: dataStr,
          sortOrder: 0,
          isEnabled: true
        })
  ...
  const columns: ColumnsType<DataSourceItem> = [
    ...
    },
    {
      ...
      render: (_: any, record: DataSourceItem) => (
        <Space size="small">
          <PermissionWrapper permission="button:guessYouLike:edit">
            <Button
              type="link"
              icon={<EditOutlined />}
          ...
          <PermissionWrapper permission="button:guessYouLike:delete">
            <Popconfirm
              title="确定要删除吗？"
              description="删除后无法恢复"
        ...
        >
          ...
          <Form.Item>
            <Space>
              ...
              <PermissionWrapper permission="button:guessYouLike:add">
                <Button
                  type="primary"
                  icon={<PlusOutlined />}
                  onClick={handleAdd}
